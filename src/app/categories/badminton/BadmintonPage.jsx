...
export default function BadmintonPage({ arenas = [] }) {
  return (
    <div>
        ...
        <div className="container my-5 py-5 px-lg-5">
          <div className="row g-5 py-5">
            <div className="col-12 text-center">
              <h1 className="text-white animated zoomIn">Badminton Arenas</h1>
              ...
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb justify-content-center">
                  ...
                  <li className="breadcrumb-item">
                    <Link className="text-white" href="/categories/badminton">Badminton</Link>
                  </li>
                </ol>
              </nav>
            </div>
      ...
      <div className="container-xxl py-5">
        <div className="container px-lg-5">
          <div className="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
            <h6 className="position-relative d-inline text-primary ps-4">Badminton Arenas</h6>
            <h2 className="mt-2">Book your favorite badminton arena now!</h2>
          </div>
          ...
          <div className="row g-4 portfolio-container" style={{ minHeight: '400px', marginBottom: '50px' }}>
            {arenas.length > 0 ? (
              ...
              <div className="col-12 text-center" style={{ minHeight: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <p className="text-muted">No badminton arenas found.</p>
              </div>
            )}
          </div>
        </div>
