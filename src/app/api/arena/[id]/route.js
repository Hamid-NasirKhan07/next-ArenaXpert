...
export async function GET(request, { params }) {
  ...
  try {
    ...
    console.error('Get arena error', err)
  }
  ...
  const sampleArenas = {
    arena1: {
      ...
      arenaDetails: {
        ...
        price: 1200,
        description: 'A premium indoor sports facility located in the heart of downtown. Perfect for cricket, football, and badminton. Features modern amenities, professional lighting, and high-quality turf.',
        ...
        closingTime: '22:00',
        images: [
          `${origin}/img/arena1.jpg`,
          `${origin}/img/arena.jpg`,
          `${origin}/img/cric.jpg`
        ]
      }
    },
    arena2: {
      ...
      arenaDetails: {
        ...
        price: 1500,
        description: 'State-of-the-art sports complex with multiple courts and facilities. Ideal for tournaments and regular practice sessions. Equipped with changing rooms, cafeteria, and parking.',
        ...
        closingTime: '23:00',
        images: [
          `${origin}/img/arena2.jpg`,
          `${origin}/img/sports.jpg`,
          `${origin}/img/sports-2.jpg`
        ]
      }
    },
    arena3: {
      ...
      arenaDetails: {
        ...
        price: 900,
        description: 'Beautiful outdoor arena with scenic lake views. Perfect for cricket and football matches. Natural grass pitch with excellent drainage system.',
    ...
    arena4: {
      ...
      arenaDetails: {
        ...
        price: 1100,
        description: 'Eco-friendly sports facility with synthetic turf. Suitable for all weather conditions. Features floodlights for evening games and comfortable seating for spectators.',
    ...
    arena5: {
      ...
      arenaDetails: {
        ...
        price: 1300,
        description: 'Multi-purpose indoor arena with air conditioning. Perfect for badminton and indoor cricket. Professional court markings and equipment available for rent.',
    ...
    arena7: {
      ...
      arenaDetails: {
        ...
        price: 1400,
        description: 'Premium sports venue with international standard facilities. Hosts professional tournaments and training camps. Includes gym, physiotherapy room, and coaching staff.',
